...
import { c as three_module_exports } from "./three.module-DxTnMYRF.js";
import { a as addEffect, c as applyProps } from "./react-three-fiber.esm-B-SMIVae.js";
...
var createInterpolator = (range, output, extrapolate) => {
	...
	return (input) => {
		...
		return interpolate$1(input, inputRange[range2], inputRange[range2 + 1], outputRange[range2], outputRange[range2 + 1], easing, extrapolateLeft, extrapolateRight, config.map);
	};
};
...
function useSprings(length, props, deps) {
	...
	function declareUpdates(startIndex, endIndex) {
		for (let i = startIndex; i < endIndex; i++) {
			...
			if (update2) updates.current[i] = declareUpdate(update2);
		}
	}
...
//#endregion
//#region node_modules/@react-spring/three/dist/react-spring_three.modern.mjs
...
var animated = createHost(primitives, { applyAnimatedValues: applyProps }).animated;
//#endregion
